    ...
    (function (e, t) {
      ...
      function pe(e, t, i) {
        ...
        for (o = [], r = n.shift(), s = j.test(r); ; ) {
          if (
            (s
              ? ((a = parseFloat(r)),
                isNaN(a) ? o.push(r) : o.push(Math.ceil(a * t * i) / i))
              : o.push(r),
            void 0 === (r = n.shift()))
          )
            return o.join("");
      ...
      (i = re),
        "function" != typeof window.CustomEvent &&
          ((se.prototype = window.Event.prototype), (window.CustomEvent = se)),
            ...
            f[Z] = t.icon,
              ...
              Object.keys(r.attributes).forEach(function (e) {
                if (
                  ((d = r.attributes[e]),
                  "style" !== e ||
                    ("string" == typeof (d = t.element.getAttribute("style")) &&
                      d.length))
                )
                  try {
                    n.setAttribute(e, d);
              ...
              a = i.style,
              c = t.element.style,
              r.verticalAlign && (a.verticalAlign = r.verticalAlign),
